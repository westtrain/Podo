...
router.get("/:id", isAuth, partyController.getParty); // 파티 상세 정보 조회
router.get("/", isAuth, partyController.getAllParties); // 전체 파티 조회
router.get("/filtered", isAuth, partyController.getFilteredParties); // 날짜별 파티 조회
router.post("/", isAuth, partyController.createParty); // 날짜별 파티 조회

  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert(
      ...
      [
        ...
        { id: 5, name: "디즈니 플러스", price: 9900, plan: "", max_num: 4 },
        { id: 6, name: "프라임 비디오", price: 7200, plan: "", max_num: 2 },
        { id: 7, name: "라프텔", price: 14900, plan: "프리미엄", max_num: 4 },
        { id: 8, name: "애플TV+", price: 6500, plan: "패밀리", max_num: 6 },
        { id: 9, name: "오피스 365", price: 11300, plan: "", max_num: 6 },
        { id: 10, name: "닌텐도", price: 3160, plan: "", max_num: 8 },
      ],
      {}
    );
  },
